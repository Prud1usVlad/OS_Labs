// MailSystem_2.0.cpp : Этот файл содержит функцию "main". Здесь начинается и заканчивается выполнение программы.
//
...
{
    cout << "Before the start, please make shure that files of the mail system \nisn't opened in file editors, to avoid mistakes and errors" << endl;
